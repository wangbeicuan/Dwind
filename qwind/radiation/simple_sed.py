...
class Radiation:
    ...
    def __init__(self, wind):
        ...
        self.FORCE_RADIATION_CONSTANT = (
            3.0 * self.wind.mdot / (2.0 * np.pi * self.wind.eta) * self.uv_fraction
        )
        self.int_hist = []
        self.int_error_hist = []
    ...
    def force_radiation(
        ...
        """
        i_aux = self.integrator.integrate_radiation(r, z)
    ...
    def force_energy(
        ...
        Returns:
            radiation force at the point (r,z) boosted by fm and attenuated by e^tau_uv.
        """
        i_aux = self.integrator.integrate_energy(r, z)
    ...
    def force_p_rr(
        ...
        Returns:
            radiation force at the point (r,z) boosted by fm and attenuated by e^tau_uv.
        """
        i_aux = self.integrator.integrate_p_rr(r, z)
...
#print(force_p_rr(1200,300,0,0))
    ...
    def force_p_phiphi(
        ...
        Returns:
            radiation force at the point (r,z) boosted by fm and attenuated by e^tau_uv.
        """
        i_aux = self.integrator.integrate_p_phiphi(r, z)
    ...
    def force_p_zz(
        ...
        Returns:
            radiation force at the point (r,z) boosted by fm and attenuated by e^tau_uv.
        """
        i_aux = self.integrator.integrate_p_zz(r, z)
    ...
    def force_p_rphi(
        ...
        i_aux = self.integrator.integrate_p_rphi(r, z)
...
#p_rz
    def force_p_rz(
        ...
        i_aux = self.integrator.integrate_p_rz(r, z)
...
#p_phiz
    def force_p_phiz(
        ...
        i_aux = self.integrator.integrate_p_phiz(r, z)
